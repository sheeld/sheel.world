...
class editor {
	...
	function view_head($values) {
		...
		// get css output
		$e = '<div class="' . $cc_class . '" style="' . container_styles($values['styles']) . '" data-content-id="' . $this->id . '" data-content-type="' . $this->content_type . '" ' . $custom_module . '>';
		$e .= $single_edit_popup;
	...
	function row_header($styles, $options, $remove_gutter, $is_fluid, $values) {
		...
		// get css output
		$e .= '<div class="mc-content-container" style="' . container_styles($styles) . '" data-content-id="' . $this->id . '" data-content-type="' . $this->content_type . '">';
