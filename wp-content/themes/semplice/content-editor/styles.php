...
<div class="atts">
	<ul class="atts-save">
		...
		<li>
			...
			<ul class="background-sub">
				...
				<li>
					...
					?>
					<div class="wp-color"><input type="text" value="<?php if($has_color === true) : echo $values['styles']['background-color']; else : echo 'transparent'; endif; ?>" class="color-picker <?php echo $values['style_class']; ?>" data-default-color="transparent" name="background-color" /></div>
				</li>
				<li>
					<div class="background-upload-box">
						<div class="ce-label">Bg Image</div>
						<a class="remove-media remove-bg" data-content-id="<?php echo $values['id']; ?>" data-media="bg-image"></a>
						<img src="<?php if($values['styles']['background-image']) : echo $values['styles']['background-image']; endif; ?>" class="bg-image-preview">
						<a class="media-upload semplice-button bg-image-upload" data-upload-type="background" data-content-id="<?php echo $values['id']; ?>">Upload image</a>
		...
		<?php if(!$values['in_column'] && $this->edit_mode !== 'single-edit') : ?>
			<li class="save-align">
				<a class="save" data-content-id="<?php echo $this->id; ?>" data-content-type="<?php echo $this->content_type; ?>">Save</a></li>
		<?php elseif($this->edit_mode === 'single-edit') : ?>
			<li class="save-align">
				<a class="save-se" data-container-id="<?php echo str_replace('#', '', $this->ccId); ?>" data-content-id="<?php echo $this->id; ?>" data-content-type="<?php echo $this->content_type; ?>" data-column-id="<?php echo $this->column_id; ?>">Save</a>
			</li>
		<?php endif; ?>
		<?php if(!$values['in_column'] && $this->edit_mode !== 'single-edit') : ?>
		<li class="layer-atts">
