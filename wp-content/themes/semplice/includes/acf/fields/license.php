        ...
        */
        ...
        function create_field( $field )
        {
				...
				if(isset($field['value']['error']) && $field['value']['error']) {
					...
					if($field['value']['product'] !== 'single' && $semplice['edition'] === 'single') {
						$update_studio .= '<div class="update-edition"><a style="background: #ffd300; margin-top: 15px;	color: #000000;	text-decoration: none; font-weight: 600; font-size: 12px; text-transform: uppercase; padding: 10px;	text-align: center;	display: block;	width: 190px;" href="' . admin_url('update-core.php') . '">Install Studio Upgrade</a></div>';
					}
				...
				// registered to or studio update
				if(isset($update_studio)) {
					echo $update_studio;
				} else {
