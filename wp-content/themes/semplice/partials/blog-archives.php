				...
				<nav>
					<ul>
						<?php
							...
							$args = array('numberposts' => '10', 'post_status' => 'publish, private', 'orderby' => 'date');
			...
			<div class="span3 archive-heading">
				...
				<nav>
					<ul>
						...
						if(get_field('exclude_categories', 'options')) {
							$exclude_categories = implode(',',get_field('exclude_categories', 'options'));	
						}
						
						// list categories
						wp_list_categories('title_li=&exclude=' . $exclude_categories);
